          ...
          <View style={styles.contentCard}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.title}>
                Organize your{'\n'}
                <Text style={styles.highlight}>day with ease</Text>
              </Text>
...
const styles = StyleSheet.create({
  ...
  blurFrame1: {
    ...
    // Note: React Native doesn't support CSS blur filter directly
    // Using shadowRadius and opacity to simulate blur effect
